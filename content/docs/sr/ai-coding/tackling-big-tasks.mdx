...
Matt Pocock-ov skill [`prd-to-issues`](https://skills.sh/mattpocock/skills/to-issues) ovo operacionalizuje: uzima PRD i izbacuje plan čije faze *jesu* vertical slice-evi, svaki dovoljno mali da stane u smart-zone context window. Da li slice-evi žive kao faze unutar jednog plana ili kao odvojeni issue-i nije bitno — bitno je da je svaki tanak, end-to-end rez.

## How this fits together

1. Napišite **PRD** — šta gradite, zašto i za koga. Bez code-level detalja.
2. Generišite **plan** vertical slice-eva — svaki end-to-end tracer bullet.
...
Sledeće: kako dizajnirati inženjersko okruženje tako da slice-evi sleću u codebase koji *pomaže* agentu — vidite [Software Quality in the AI Era](/sr/docs/ai-coding/software-quality-in-the-ai-era).

Pozadinsko čitanje: [Context window limits](/sr/docs/fundamentals/how-llms-are-built#context-window).
