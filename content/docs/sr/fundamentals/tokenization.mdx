...
Za to kako se tokeni uklapaju u širu sliku gradnje modela, vidite [How LLMs Are Built](/sr/docs/fundamentals/how-llms-are-built).

## Sources

- Petrov, Malkin et al. — [*Language Model Tokenizers Introduce Unfairness Between Languages*](https://arxiv.org/abs/2305.15425). Peer-reviewed studija o tokenization-u kroz jezike (arXiv 2305.15425).
