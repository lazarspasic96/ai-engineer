---
title: Uvod
description: Šta ovaj kurs pokriva i kome je namenjen — putokaz od osnova do izgradnje sistema sa LLM-ovima.
order: 1
---
...
- **Osnove linearne algebre** — vektori, matrice, skalarni proizvodi
- **Opšti programski koncepti** — API-ji, strukture podataka, kontrola verzija
